        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-2">
            ...
            <div class="row">
              ...
              $query = "SELECT * FROM accommodation WHERE accommodation_category='hotels'";
              ...
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '        <img class="card-img h-100 " src="assets/img/accommodation/hotels/' . $row['accommodation_image'] . '" alt="' . urldecode($row['accommodation_title']) . '" loading="lazy">';
                echo '      </div>';
                echo '      <div class="col-6 " >';
          ...
          <div class="tab-pane" id="tab-3">
            ...
            <div class="row">
              ...
              $query = "SELECT * FROM accommodation WHERE accommodation_category='budget'";
              $result = mysqli_query($db, $query);
              $counter = 1;
              while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '    <div class="row h-100">';
                echo '      <div class="col-6">';
                echo '        <img class="card-img h-100 " src="assets/img/accommodation/budget/' . $row['accommodation_image'] . '" alt="' . urldecode($row['accommodation_title']) . '" loading="lazy">';
                echo '      </div>';
                echo '      <div class="col-6 " >';
                echo '        <div class="card-body ">';
                echo '          <h5 class="card-title">' . urldecode($row['accommodation_title']) . '</h5>';
